...
public class SwipeAttackState : IComponent
{
    ...
    {
        hitbox = new GameObject(100, 200);
        hitbox.type = "EnemyBossHitBox";
        hitbox.AddComponent(new BoxCollider(new Vector2(1700, 200), Vector2.Zero, GOManager.Instance.GraphicsDevice));
        GOManager.Instance.allGOs.Add(hitbox);
    }
    void SpawnLowHitBox()
    {
        hitbox = new GameObject(100, 550);
        hitbox.type = "EnemyBossHitBox";
        hitbox.AddComponent(new BoxCollider(new Vector2(1700, 200), Vector2.Zero, GOManager.Instance.GraphicsDevice));
        GOManager.Instance.allGOs.Add(hitbox);
    }
