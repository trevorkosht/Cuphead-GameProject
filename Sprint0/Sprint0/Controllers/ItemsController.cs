    ...
    internal class ItemsController
    {
        ...
        public ItemsController(Texture2DStorage textureStorage)
        {
            ...
            Items = new List<GameObject>()
            {
                ...
                new GameObject((int)itemPosition.X, (int)itemPosition.Y, new Cuphead.Items.BluePotion(itemPosition, textureStorage.GetTexture("Item4_6"))),
                new GameObject((int)itemPosition.X, (int)itemPosition.Y, new Cuphead.Items.OceanbluePotion(itemPosition, textureStorage.GetTexture("Item4_6"))),
                new GameObject((int)itemPosition.X, (int)itemPosition.Y, new Cuphead.Items.RedKetchupPotion(itemPosition, textureStorage.GetTexture("Item4_6")))
            };
            currentItem = Items[0];
