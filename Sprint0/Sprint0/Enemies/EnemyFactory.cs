    ...
    public static BaseEnemy CreateEnemy(EnemyType type, Texture2DStorage textureStorage)
    {
        ...
        switch (type)
        {
            case EnemyType.AggravatingAcorn:
                ...
                enemy.addAnimation("aggravatingAcornAnimation", new Animation(textureStorage.GetTexture("AggravatingAcorn"), 5, 20, 144, 144));
            ...
            case EnemyType.DeadlyDaisy:
                ...
                enemy.addAnimation("deadlyDaisyAnimation", new Animation(textureStorage.GetTexture("DeadlyDaisy"), 3, 16, 144, 144));
            ...
            case EnemyType.MurderousMushroom:
                ...
                enemy.addAnimation("murderousMushroomAnimation", new Animation(textureStorage.GetTexture("MurderousMushroom"), 5, 8, 144, 144));
            ...
            case EnemyType.TerribleTulip:
                ...
                enemy.addAnimation("terribleTulipAnimation", new Animation(textureStorage.GetTexture("TerribleTulip"), 5, 15, 144, 144));
            ...
            case EnemyType.BothersomeBlueberry:
                ...
                enemy.addAnimation("bothersomeBlueberryAnimation", new Animation(textureStorage.GetTexture("BothersomeBlueberry"), 5, 12, 144, 144));
            ...
            case EnemyType.ToothyTerror:
                ...
                enemy.addAnimation("toothyTerrorAnimation", new Animation(textureStorage.GetTexture("ToothyTerror"), 5, 4, 144, 144));
